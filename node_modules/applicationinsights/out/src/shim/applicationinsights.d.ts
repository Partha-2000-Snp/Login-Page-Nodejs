 ...
 */
export declare function startOperation(arg1: azureFunctionsTypes.Context | (http.IncomingMessage | azureFunctionsTypes.HttpRequest) | SpanContext | Span, arg2?: HttpRequest | string): ICorrelationContext | null;
/**
