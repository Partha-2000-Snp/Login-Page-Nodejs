...
import { ICorrelationContext, ITraceparent, HttpRequest } from "./types";
export declare class CorrelationContextManager {
     ...
     * @returns IcorrelationContext object
     */
    static startOperation(input: azureFunctionsTypes.Context | (http.IncomingMessage | azureFunctionsTypes.HttpRequest) | SpanContext | Span, request?: HttpRequest | string): ICorrelationContext;
    /**
